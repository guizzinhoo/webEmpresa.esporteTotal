       ...
       <body>
              ...
              <body>
                     <div class="container cont-produto">
                            <div class="add-novo-produto">
                                   <h2 class="title">Novo Produto</h2>
                                   <!-- Inicio formulario contato -->
                                   <div class=" formulario-contato">
                                          <form action="InsereProduto.php" method="post" class="mt-2">
                                                 <label class="form-label">Codigo</label>
                                                 <input type="number" name="cod" class="form-control mb-2">
                                                 <label class="form-label">Nome</label>
                                                 <input type="text" name="nome" class="form-control mb-2">
                                                 <label class="form-label">Quantidade</label>
                                                 <input type="number" name="qtd" class="form-control mb-2">
                                                 <div>
