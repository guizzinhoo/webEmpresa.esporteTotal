...
<body>
    ...
    <body>
        <div class="bkg-img">
            <div class="favoritos add-foto-produto">
                <h2 class="title">Escolher Foto do Produto</h2>
                <div>
                    <form action="ProdutoImagem.php" method="post" enctype="multipart/form-data" class="form mt-2">
                        <?php
                        $codigo = $_GET['cod'];
